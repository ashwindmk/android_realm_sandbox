...
public class DeleteModule extends AbstractSavedStateViewModelFactory {
     ...
     */
    public DeleteModule(@NonNull SavedStateRegistryOwner owner, @Nullable Bundle defaultArgs, RecordRepository recordRepository) {
    ...
    protected <T extends ViewModel> T create(@NonNull String key, @NonNull Class<T> modelClass, @NonNull SavedStateHandle handle) {
        if (modelClass.isAssignableFrom(DeleteViewModel.class)) {
            return (T) new DeleteViewModel(handle, recordRepository);
        }
